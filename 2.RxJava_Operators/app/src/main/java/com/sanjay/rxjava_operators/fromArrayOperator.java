...
public class fromArrayOperator extends AppCompatActivity {
    ...
    String TAG="FROMARRAYOPERATOR";
    String[] greetings = {"Hello A","Hello B","Hello C"};
    Integer [] intArray = {1,2,3,4,5,67,88};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //observable for from array operator
        observable = Observable.fromArray(intArray);
